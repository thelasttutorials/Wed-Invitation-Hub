export type ThemeSlug = "luxury-gold" | "romantic-floral" | "minimal-modern" | "classic-elegant" | "eternal-rose";
...
const THEMES: Record<ThemeSlug, ThemePreset> = {
  ...
  "eternal-rose": {
    ...
    badge: "Baru",
    primaryColor: "#B83267",
    secondaryColor: "#FCE8F0",
    backgroundColor: "#FFF6F9",
    textColor: "#3D0E20",
    textMutedColor: "#8B4563",
    accentColor: "#E8A0BC",
    coverOverlayStart: "rgba(100,18,50,0.55)",
    coverOverlayEnd: "rgba(184,50,103,0.72)",
    fontHeading: "'Playfair Display', Georgia, serif",
    fontBody: "'Plus Jakarta Sans', sans-serif",
    buttonBg: "#B83267",
    buttonText: "#ffffff",
    buttonHoverBg: "#9B2557",
    cardBg: "#FFFAFC",
    cardBorder: "#F0B8D0",
    sectionAltBg: "#FDF0F5",
    countdownCardBg: "rgba(184,50,103,0.10)",
    countdownTextColor: "#B83267",
    ornamentColor: "#E8A0BC",
    dividerColor: "#F0B8D0",
    primaryBtn: "bg-[#B83267] hover:bg-[#9B2557] text-white border-0",
    outlineBtn: "border-[#B83267] text-[#B83267] hover:bg-[#B83267]/10",
    cssVars: {
      "--theme-primary": "#B83267",
      "--theme-secondary": "#FCE8F0",
      "--theme-bg": "#FFF6F9",
      "--theme-text": "#3D0E20",
      "--theme-muted": "#8B4563",
      "--theme-accent": "#E8A0BC",
      "--theme-card-bg": "#FFFAFC",
      "--theme-card-border": "#F0B8D0",
      "--theme-section-alt": "#FDF0F5",
      "--theme-countdown-bg": "rgba(184,50,103,0.10)",
      "--theme-countdown-text": "#B83267",
      "--theme-divider": "#F0B8D0",
      "--theme-font-heading": "'Playfair Display', Georgia, serif",
      "--theme-font-body": "'Plus Jakarta Sans', sans-serif",
    },
  },
